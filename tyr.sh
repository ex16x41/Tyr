...
echo -e "\e[00;33m\e[00m" "\e[01;32m
@@@@@@@@@@@@@@@@@@@@@@@@   @@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@             @@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@       (     %      #@@@@@@@@@@@@@@
@@@@@@@@@@@@   %                   %  /@@@@@@@@@@@
...
@@@@@@@@@@@@@@@@@@  @  &     ,,  @@@@@@@@@@@@@@@@@  
	...
	Tyr Script for Web Dorks Enumeration 
                                                        \e[00m" "\e[00;33m\e[00m"
echo -e "\e[00;33m# https://www.linkedin.com/in/evaprokofiev1 | @ex16x41\e[00m"
...
# Exploit
echo -e "\e[01;32mChecking Security Misconfigurations:\e[00m"; PrintTheResults "${misconfigearray[@]}";
echo -e "\e[01;32mChecking HIdden Gems:\e[00m"; PrintTheResults "${hiddenearray@]}";
